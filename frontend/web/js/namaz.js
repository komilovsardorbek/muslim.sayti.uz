$(document).click(function(){
    $('.dropdown').find('.down_inner').toggleClass('rotate');
});
...
$('.page-nav__toggler').click(function(){
    $(".page-nav__collapse").addClass('show')
});

$('.close_bar').click(function(){
    $(".page-nav__collapse").removeClass('show')
});
$('.page-nav__toggler').click(function(){
...
$(document).ready(function () {
    $('.mobile_dropdown-inner').click(function () {
        if ($(this).next(".mobile_dropdown-wrapper").hasClass('active')) {
            $(this).next(".mobile_dropdown-wrapper").removeClass('active').slideUp()
        } else {
            $(".mobile_dropdown-wrapper").removeClass('active').slideUp()
            $(this).next('.mobile_dropdown-wrapper').addClass('active').slideDown();
        }
        $(this).find('.iconslang').toggleClass('change_inos');
    });
});
